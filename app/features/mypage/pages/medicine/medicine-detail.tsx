...
export default function MedicineDetail() {
  return (
    <>
      <PageTitle title="약품 상세 이력 관리" desc="약품 관리 페이지 입니다. 페이지 설명 텍스트가 들어갑니다." />
      <Container>
        <CustomTable
          tableHead={
            <>
          ...
          <TableRow
            accordion
            title={<p>타이레놀 <span className="font-normal">(2025-05-03 12:00)</span></p>}>
            ...
            <TableTd label="이름" className="!hidden lg:!flex flex-1">
              <p className="grow lg:text-center font-bold">타이레놀</p>
            </TableTd>
