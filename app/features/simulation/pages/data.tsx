...
import {AccordionDataTable} from "~/features/simulation/components/accordion-data-table";
import {
  DataTable,
  DataTableHead,
  DataTableTd,
      ...
      <Container>
        <PageUtilLine>
          <div className="w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-4 ">
            ...
            <CustomBtn variant="primary" rightIcon={<Plus/>}>신규 분석</CustomBtn>
          </div>
        </PageUtilLine>
        <div className="flex flex-col gap-4">
          <AccordionDataTable
            headers={['계획수립날짜', '총 계획 출하 중량', '총 비용', '총 예측 수익']}
            rows={[
              {
                row: ['2025-04', '-', '3,800', '4,000,000'],
                content: (
                  <>
                  <DataTable>
                    <DataTableHead>
                  ...
                  <div className="flex flex-col lg:flex-row gap-1 lg:gap-2 lg:items-center lg:justify-between">
                    <span className="text-slate-500">화면을 좌우로 스크롤하시면 전체 표를 확인하실 수 있습니다.</span>
